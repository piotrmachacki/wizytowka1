...
!function(){$(".carousel-showmanymoveone .item").each(function(){for(var a=$(this),b=1;3>b;b++)a=a.next(),a.length||(a=$(this).siblings(":first")),a.children(":first-child").clone().addClass("cloneditem-"+b).appendTo($(this))})}();